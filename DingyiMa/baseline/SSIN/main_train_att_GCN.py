...
from SSIN.Trainer_ATT_GCN import MaskedTrainer
...
def get_data_path(args):
    ...
    if args.dataset.lower() == "hk":
        ...
        args.batch_size = 64
    elif  args.dataset.lower() == "ndbc":
        dataset_dir = f"{base_dir}/NDBC"
        args.output_dir = f"./output/NDBC/{args.sub_out_dir}"
        args.data_prefix = "2012-2014"
